...
@interface LeftOUTEROperation()
@end
@implementation LeftOUTEROperation
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wundeclared-selector"
-(NSString *)content:(Class)origin{
    return [self performSelector:@selector(content:Join:) withObject:origin withObject:@" LEFT OUTER JOIN "];
}
